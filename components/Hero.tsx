...
const Hero = () => {
  return (
    <div className="pb-20 pt-36 min-h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.03] bg-grid-black-100/[0.2] flex items-center justify-center relative">
      {/**
       *  UI: Spotlights
